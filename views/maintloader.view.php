...
?>
<div class="ml-page">
	<h1 class="ml-title"><?= $e(_('Maintenance loader')) ?></h1>
...
<?php endif; ?>
	...
	<div class="ml-tabs" role="tablist">
		<button type="button" class="ml-tab ml-tab-active" data-tab="new"><?= $e(_('New window')) ?></button>
		<button type="button" class="ml-tab" data-tab="active"><?= $e(_('Windows in flight')) ?> <span id="ml-active-count" class="ml-pill ml-pill-grey">0</span></button>
	</div>
	...
	<!-- ============================ ACTIVE ============================= -->
	<section id="ml-panel-active" class="ml-panel ml-hidden">
		<div class="ml-row ml-filter-row">
